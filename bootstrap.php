	...
	final public static function loadClass(string $class): void {
		...
		if (strpos($class, '_PHPStan_') === 0) {
			...
			if (self::$composerAutoloader === null) {
				self::$composerAutoloader = require $downloadedPharPath . '/vendor/autoload.php';
				require_once $downloadedPharPath . '/vendor/jetbrains/phpstorm-stubs/PhpStormStubsMap.php';
				require_once $downloadedPharPath . '/vendor/react/async/src/functions_include.php';
				require_once $downloadedPharPath . '/vendor/react/promise/src/functions_include.php';
			}
		...
		if (!self::$polyfillsLoaded) {
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php80/Php80.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php80/bootstrap.php';
			}
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-mbstring/Mbstring.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-mbstring/bootstrap.php';
			}
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-intl-normalizer/Normalizer.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-intl-normalizer/bootstrap.php';
			}
			...
			if (
				...
				// require_once $downloadedPharPath . '/vendor/symfony/polyfill-php73/Php73.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php73/bootstrap.php';
			}
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php74/Php74.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php74/bootstrap.php';
			}
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-intl-grapheme/Grapheme.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-intl-grapheme/bootstrap.php';
			}
			...
			if (
				...
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php81/Php81.php';
				require_once $downloadedPharPath . '/vendor/symfony/polyfill-php81/bootstrap.php';
			}
		}
		...
		if (strpos($class, 'PHPStan\\BetterReflection\\') === 0) {
			...
			$filepath = $downloadedPharPath . '/vendor/ondrejmirtes/better-reflection/src/' . $filename . '.php';
		} else {
			$filename = substr($filename, strlen('PHPStan\\'));
			$filepath = $downloadedPharPath . '/src/' . $filename . '.php';
		}
